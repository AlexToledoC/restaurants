...
int main ()
{
	...
	do 
	{
		...
		switch(seleccion)
		{
			...
			case 2:
			{
				cout << "Escoge el tamaño para tu pizza de pepperoni\nIngresa el respectivo número\n1. Mediana\n2. Familiar\n3.Familiar con orilla de queso\n";
				cin >> tamano_pizza;
				if (tamano_pizza == 1)
				{
					acumulado = pizza_mediana;
			...
			case 3:
			{
				cout << "Escoge el tamaño para tu pizza hawaiana\nIngresa el respectivo número\n1. Mediana\n2. Familiar\n3.Familiar con orilla de queso\n";
				cin >> tamano_pizza;
				if (tamano_pizza == 1)
				{
					acumulado = pizza_mediana;
			...
			case 4:
			{
			cout << "Escoge el tamaño para tu pizza mexicana\nIngresa el respectivo número\n1. Mediana\n2. Familiar\n3.Familiar con orilla de queso\n";
				cin >> tamano_pizza;
				if (tamano_pizza == 1)
				{
					acumulado = pizza_mediana;
			...
			case 5:
			{
				cout << "Escoge el tamaño para tu pizza de nutella\nIngresa el respectivo número\n1. Mediana\n2. Familiar\n";
				cin >> tamano_pizza;
				if (tamano_pizza == 1)
				{
					acumulado = pizza_mediana;
			...
			case 6:
			{
				printf("\nEnsalada de pollo añadida al carrito");
				acumulado = precio_ensalada;
				break;
			}
			case 7:
			{
				printf("\nEnsalada de atún añadida al carrito");
				acumulado = precio_ensalada;
				break;
			}
			case 8:
			{
				printf("\nEspagueti a la boloñesa añadido al carrito");
	...
	while (otro_producto == "si" or otro_producto == "Si" or otro_producto == "Sí");
	...
	else
	{
		...
		cout << "\n\n¿Requiere factura?\nEscoja con el respectivo número\n 1. Si \n 2. No \n";
		cin >> factura;
		if (factura == 1)
		{
